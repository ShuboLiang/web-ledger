...
export class ShoppingController {
  ...
  create(@Body() body: Record<string, unknown>) {
    return this.shopping.create(this.currentUser.ledgerId, body)
  }

  @Patch(":id")
  update(@Param("id") id: string, @Body() body: Record<string, unknown>) {
    return this.shopping.update(this.currentUser.ledgerId, id, body)
  }

  @Delete(":id")
  remove(@Param("id") id: string) {
    return this.shopping.remove(this.currentUser.ledgerId, id)
  }
