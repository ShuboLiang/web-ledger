...
import { IsArray, IsIn, IsNumber, IsOptional, IsString, Matches, MaxLength, ValidateNested } from "class-validator";
...
export class TransactionBatchDto {
  @IsArray() @ValidateNested({ each: true }) @Type(() => TransactionInputDto)
