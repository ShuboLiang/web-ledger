...
export class ManagementController {
  ...
  @Get("budgets") budgets(@Query("month") month: string) { return this.management.budgetOverview(month); }
  @Post("budgets/copy-previous") copyPreviousBudgets(@Body("month") month: string) { return this.management.copyPreviousBudgets(month); }
  @Patch("budgets/:id") updateBudget(@Param("id") id: string, @Body() body: Record<string, unknown>) { return this.management.updateBudget(id, body); }
  @Delete("budgets/:id") deleteBudget(@Param("id") id: string) { return this.management.deleteBudget(id); }
